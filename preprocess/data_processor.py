...
class DataProcessor(object):
    def __init__(self):
        self.cartoons_path = os.path.join(ROOT_DIR, 'dataset', 'cartoons')
        self.persons_path = os.path.join(ROOT_DIR, 'dataset', 'persons')
    ...
    def process_dataset(self):
        ...
        count = 0
        train_person_dir = os.path.join(ROOT_DIR, 'dataset', 'zhengsheng_s2a', 'trainA')
        test_person_dir = os.path.join(ROOT_DIR, 'dataset', 'zhengsheng_s2a', 'testA')
        ...
        count = 0
        train_cartoon_dir = os.path.join(ROOT_DIR, 'dataset', 'zhengsheng_s2a', 'trainB')
        test_cartoon_dir = os.path.join(ROOT_DIR, 'dataset', 'zhengsheng_s2a', 'testB')
